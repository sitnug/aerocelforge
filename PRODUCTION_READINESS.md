...
Audit date: 2026-07-20. This record separates a working vertical slice from a
...
| ------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Foundation             | Verified vertical slice             | Tauri 2/React workspace, strict versioned schema, SI internal units, atomic managed autosave, blank create/open/delete file manager, explicit save, capability detection, persistent Bright/Cockpit themes, Simple/Advanced views, accessible plain-language help, resizable native window, explicit application fullscreen and simulator Focus mode | Project duplication/rename, portable project bundles, and cross-version migrations beyond 1.0.0 remain backlog                                                                                                                  |
| 2. Geometry               | Partial, hardened                   | Explicit format/unit/type selection, picker and drag/drop, local STL/OBJ/glTF/GLB/PLY/DAE parsing, topology/quality checks, source hashing/archive/restore, assembly parenting, editable basic-part library, numeric transforms, and direct 3D move/turn handles                                                                                     | STEP/IGES/3MF/VSP3/URDF/SDF/DXF require adapters; self-intersection, minimum thickness, healing, mirroring, alignment, snapping, sections, arrays, and grouping are incomplete                                                  |
| 3. Propulsion and joints  | Partial                             | P0/P1/P2 contracts and calculations, P3/P4 boundaries, independently placed propulsion forces, CW/CCW reaction torque, per-propeller power/key controls, tilt joints, thrust/gyro/slipstream/battery and failure models                                                                                                                              | General attachment-point editor, all advanced joint types/dynamics, collision/clearance tooling, and blade-resolved CFD are incomplete                                                                                          |
| 4. Rapid aerodynamics     | Partial                             | Geometry-derived pressure, skin drag, and bounded surface-normal reaction; unnamed imported meshes produce lift/drag/side force and moments from triangle size/orientation/local wind; imported movable-surface panels deflect; procedural parts retain A1; atmosphere, stability estimates, polar/span/glide outputs, CSV export                    | Validated interference buildup, boundary-layer/viscous and separated-flow mesh solutions, wake/circulation solves, A0 table editing, and full A2 VLM/A3 integrations are incomplete; coefficients require traceable calibration |
| 5. Flight dynamics        | Partial, interactive slice          | Native quaternion nonlinear 6-DOF, RK4, trim, deterministic sensors and wind; forces and `r × F` moments at actual parts relative to CG; controls require fitted aileron/elevator/rudder/flap parts; manual unpowered glide; propulsion-gated stabilized/automatic modes; separate propeller control; gamepad/keyboard, contact and telemetry        | Live JSBSim/PX4 transport, terrain and full collision world, actuator latency, ground effect, spin/dynamic-stall and rotor-interference validation, transmitter calibration, and physical model calibration are incomplete      |
