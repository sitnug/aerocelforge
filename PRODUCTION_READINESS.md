...
| 4. Rapid aerodynamics     | Partial                             | A1 attached-flow polar plus interactive per-part local-flow forces; individual lifting-surface size/orientation/stall/drag inputs; imported-mesh triangle pressure panels; atmosphere, stability estimates, polar/span/glide outputs, CSV export                                                                             | Validated parasite/interference buildup, viscous/separated-flow mesh solution, A0 table editing, and full A2 VLM/A3 integrations are incomplete; coefficients require traceable calibration                                |
