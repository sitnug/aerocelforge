...
| ------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1. Foundation             | Verified vertical slice             | Tauri 2/React workspace, strict versioned schema, SI internal units, atomic managed autosave, most-recent-project recovery, capability detection                                              | Full create/open/duplicate project UI and cross-version migrations beyond 1.0.0 remain backlog                                                                                 |
...
| 4. Rapid aerodynamics     | Partial                             | A1 analytical/component buildup, atmosphere, stability estimates, polar/span/glide outputs, CSV export                                                                                        | A0 table editor and full A2 VLM/A3 panel integrations are incomplete; separated and rotor-dominated regimes require higher fidelity                                            |
| 5. Flight dynamics        | Partial                             | Native quaternion nonlinear 6-DOF, RK4, trim, deterministic sensors, wind/control contracts, and logs                                                                                         | Live JSBSim adapter, complete takeoff/landing/collision world, spin/stall validation, and model calibration are incomplete                                                     |
