...
| 4. Rapid aerodynamics     | Partial                             | Geometry-derived A1 profile/pressure/skin drag plus attached-flow polar and interactive per-part local-flow forces; individual lifting-surface size/orientation/stall/drag inputs; imported-mesh triangle pressure panels; atmosphere, stability estimates, polar/span/glide outputs, CSV export                                                     | Validated interference buildup, boundary-layer/viscous and separated-flow mesh solutions, A0 table editing, and full A2 VLM/A3 integrations are incomplete; coefficients require traceable calibration                     |
